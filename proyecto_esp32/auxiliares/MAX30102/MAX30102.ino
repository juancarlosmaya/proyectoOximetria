...
/* TIA gain and the LED current to achieve the target threshold DC value of
40% of ADC full scale. (TexasInstruments)
*/
/*
changes the PWM duty cycle value to adjust the LED intensity for every kind of user. (NXP)
*/
