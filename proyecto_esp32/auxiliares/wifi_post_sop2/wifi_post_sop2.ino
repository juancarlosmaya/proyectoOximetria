...
void setup()
{
    ...
    // PONER AQUÌ CLAVE Y CONTRASEÑA
    //WiFiMulti.addAP("iPhone", "jc12345678");
    //WiFiMulti.addAP("ERAZO", "sofia108516#");

    Serial.println("Iniciando conexiòn wifi");
    WiFi.begin("iPhone", "jc12345678");
...
void loop()
{
    ...
    int vector[] = {85,86,87,88,89,90,91,92,91,90,89,89,90,89,88,87,86,85,84,83}; // señal a enviar
    int tiempo;
