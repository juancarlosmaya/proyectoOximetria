...
def obtenerValorAcDc(senal,fs):
    ...
    plt.plot(espectroSenalAC[1][0:50])
    # obtener valorDC
...
tiempo=np.arange(x,x+512)
senalIR=infrarojo[x:x+512]
senalRojo=rojo[x:x+512]
...
##############3
#np.savetxt('senalRojoconHamming.csv',senalFiltrada,delimiter=';')
